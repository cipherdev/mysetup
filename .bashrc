...
alias tftpdir='cd /var/lib/tftpboot'
#alias localgit='cd /projects/hcm/storm/users/hule/localgit'
#alias capture='sleep 0.2 ; scrot -s 'Image_%Y-%m-%d_at_%I:%M:%S-%p.png' -e 'mv $f /home/huyle/Pictures''
